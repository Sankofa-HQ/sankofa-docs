...
The Sankofa Web SDK is the core integration layer for browser-based applications. It provides a high-level API for tracking user behavior, capturing identity profile updates, and recording user sessions via session replay.
