...
:::note Free tier has a per-module seat cap
Each product's Free tier caps the number of humans who can use that module: Catch / Pulse / Switch / Config / Deploy / Analytics Free = **3 seats**; Plan Free = **10 seats**. Every paid tier (Starter / Pro / Growth / Enterprise) is unlimited seats per module.
