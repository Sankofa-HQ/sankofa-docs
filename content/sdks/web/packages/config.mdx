...
description: Typed remote config for the web. A single generic get<T> that infers the return type from the default, plus decision envelopes, cohort-targeted overrides, and onChange subscriptions.
toc: true
sdks: [web]
---
