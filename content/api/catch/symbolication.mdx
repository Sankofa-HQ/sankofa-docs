...
Symbols don't count toward your monthly events quota — they're a separate flat-rate capacity per project tier. Free tier limits to ~5 GB of symbols; Pro and above are effectively uncapped (we'll reach out before we cap a customer).
