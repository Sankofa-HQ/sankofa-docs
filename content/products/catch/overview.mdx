...
| Endpoint | Purpose |
|---|---|
| `POST /api/ee/catch/ingest/events` | Error events |
| `POST /api/ee/catch/ingest/transactions` | Transactions + spans |
| `POST /api/ee/catch/ingest/vitals` | Web vitals |
| `POST /api/ee/catch/ingest/profiles` | Sampling profiler output |
