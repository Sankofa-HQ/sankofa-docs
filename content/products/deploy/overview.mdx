...
| **Flutter** | `sankofa_flutter` | Dart code | `SankofaUpdater` |

Both are App Store + Play Store compliant. See the [Flutter SDK overview](/sdks/flutter/overview#deploy-flutter-ota-updates) for the customer-facing API.
