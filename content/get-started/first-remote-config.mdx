...
| an A/B variant with stat-sig metrics | [Switch variants](/products/switch/overview) or [Config A/B experiments](/products/config/overview) |
...
<CardGrid cols={3}>
  ...
  <Card href="/products/switch/overview" eyebrow="Switch" title="Switch deep dive">
    Feature flags, variants, experiments, halt webhooks.
  </Card>
